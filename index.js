console.log("Bienvenido a la calculadora de JS")



operacion=prompt("Introduzca la operacion que desea realizar, si necesita ayuda introduzca ayuda", "")
...
if (operacion == "*") {
  ...
  console.log("El resultado es:", multi3)
};
...
if (operacion == "/") {
  ...
  console.log("El resultado es:", divi3)
};
